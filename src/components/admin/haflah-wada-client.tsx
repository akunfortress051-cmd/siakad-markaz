      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-6">
        <div className="flex bg-slate-100 p-1 rounded-xl w-full md:w-auto">
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition ${activeTab === "denah" ? "bg-white text-slate-900 shadow-sm" : "text-slate-500 hover:text-slate-700"}`}
          >
          ...
          <button
            ...
            className={`flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg text-sm font-bold transition ${activeTab === "pemanggilan" ? "bg-white text-slate-900 shadow-sm" : "text-slate-500 hover:text-slate-700"}`}
          >
        ...
        <div className="flex items-center justify-between w-full md:w-auto gap-4">
          <div className="text-sm font-semibold text-slate-500">
            Total Masuk: <span className="font-bold text-slate-900">{processedSantri.length} Santri</span>
          </div>
          <button
            onClick={handleExportPDF}
            disabled={exporting}
            className="flex items-center justify-center gap-2 bg-emerald-600 hover:bg-emerald-700 disabled:bg-emerald-400 text-white px-4 py-2 rounded-xl font-bold shadow-sm transition"
          >
